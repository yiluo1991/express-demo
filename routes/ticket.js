...
router.get('/edit', validator.valid({
    rules: [
        { prop: "title", displayName: "标题", max: 10, min: 5, required: true },
        { prop: 'price', displayName: "价格", max: 9999999, min: 0, required: true, type: "number" }
    ],
    method: "get"
}), function (req, res) {
